...
(async function () {
    ...
    const inputs = await GenerateCircuitInputs(
        ...
        // api inputs    
        apiInputs.availableWeight, apiInputs.cikRoot, apiInputs.cikSiblings, apiInputs.censusRoot, apiInputs.censusSiblings
    );
